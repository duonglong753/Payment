...
namespace Payment.Application.Constants
{
    public class MerchantConstants
    {
        ...
        public static string SelectWithCriteriaSprocName => "sproc_MerchantSelectedByCriteria";
        public static string SelectByIdSprocName => "sproc_MerchantSelectById";
        public static string SelectPagingSprocName => "sproc_MerchantSelectedByCriteriaPaging";
    }
}
